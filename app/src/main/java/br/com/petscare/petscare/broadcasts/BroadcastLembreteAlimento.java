...
public class BroadcastLembreteAlimento extends BroadcastReceiver {
    @Override
    ...
    public void gerarNotificacao(Context context, Intent intent){
        ...
        builder.setContentText("Não se esqueça de alimentar seu Pet! ;)");
        ...
        String[] descricoes = new String[]{"Lembrete automático","Alimente seu Pet","Lembre-se de trocar a água",":)"};
