...
public class BroadcastLembreteTosa extends BroadcastReceiver {
    @Override
    ...
    public void gerarNotificacao(Context context, Intent intent){
        ...
        builder.setContentText("Não se esqueça da tosa do seu Pet! ;)");
        ...
        String[] descricoes = new String[]{"Lembrete automático","Em 2 horas, leve seu Pet para a tosa marcada"};
