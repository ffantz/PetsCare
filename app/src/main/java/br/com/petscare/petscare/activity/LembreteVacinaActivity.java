...
public class LembreteVacinaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lembrete_vacina);
        ...
        toolbar.setTitle("Lembretes de Vacinação");

        editHorario = (EditText) findViewById(R.id.editText_horario_vacina);
        ...
        editData = (EditText) findViewById(R.id.editText_data_vacina);
        ...
        botao = (Button) findViewById(R.id.button_adicionar_lembrete_vacina);
            ...
            public void onClick(View view) {
                if(!editData.getText().toString().equals("") && !editHorario.getText().toString().equals("")){
                    if(validarData()) {
                        ...
                        Toast.makeText(LembreteVacinaActivity.this, "Insira uma data válida.", Toast.LENGTH_SHORT).show();

                    }

                }else{
                    Toast.makeText(LembreteVacinaActivity.this, "Por favor, preencha todos os campos.", Toast.LENGTH_SHORT).show();
    ...
    public void validarAlarme(){
        ...
        if(alarmeAtivo) {
            Intent intent = new Intent("ALARME_LEMBRETE_VACINA");
